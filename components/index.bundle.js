/* AUTO-GENERATED by scripts/bundle-fdic-epic-components.mjs — do not edit by hand.
   ...
   Source: 21 modules concatenated from components/.
*/
(function(){
...
(function(){
  __fdic_modules["prototype-storage.mjs"] = __fdic_modules["prototype-storage.mjs"] || {};
const PROTOTYPE_SESSION_TTL_HOURS = 12;
const PROTOTYPE_SESSION_TTL_MS = PROTOTYPE_SESSION_TTL_HOURS * 60 * 60 * 1000;

const CASE_HISTORY_METADATA_KEYS = [
  "caseId",
  "submittedAt",
  "workflowHeading",
  "topicTitle",
...
function createCaseHistoryEntry(submittedCase) {
  const entry = {};
...
function sanitizeCaseHistory(history) {
  ...
  __fdic_modules["prototype-storage.mjs"].PROTOTYPE_SESSION_TTL_HOURS = PROTOTYPE_SESSION_TTL_HOURS;
  __fdic_modules["prototype-storage.mjs"].PROTOTYPE_SESSION_TTL_MS = PROTOTYPE_SESSION_TTL_MS;
  __fdic_modules["prototype-storage.mjs"].CASE_HISTORY_METADATA_KEYS = CASE_HISTORY_METADATA_KEYS;
  __fdic_modules["prototype-storage.mjs"].getPrototypeStorageTimestamp = getPrototypeStorageTimestamp;
  __fdic_modules["prototype-storage.mjs"].isPrototypeSessionRecordFresh = isPrototypeSessionRecordFresh;
  __fdic_modules["prototype-storage.mjs"].createCaseHistoryEntry = createCaseHistoryEntry;
  __fdic_modules["prototype-storage.mjs"].sanitizeCaseHistory = sanitizeCaseHistory;
})();
